---
tags: [ChatGpT, os, agents]
---

## **How to Build an AI Chatbot with Spring AI, React, and Docker

  ![[Plastic robot head.jpg]]

Hey Java developers, I’ve got good news: Spring now has official support for building AI applications using the [Spring AI](https://spring.io/projects/spring-ai) module.

In this tutorial, we’ll build a chatbot application using [**Spring Boot**](https://spring.io/projects/spring-boot), [**React**](https://react.dev/), [**Docker**](https://www.docker.com/), and [**OpenAI**](https://openai.com/). This app will let users interact with an AI-powered chatbot, ask questions, and receive responses in real time.

The entire source code mentioned in this article is already available on the [GitHub repository](https://github.com/vikasrajputin/springboot-react-docker-chatbot). Feel free to give it a star and fork it to play around.

To give you an idea of what we’ll be building here, this is how the final application will look:

![[e89f90afd0e6e45513057e880056528d_MD5.jpg]]

Are you excited? Let’s build it from scratch!

## **Table of Contents**

-   [Prerequisites](https://www.freecodecamp.org/news/ai-chatbot-with-spring-react-docker/?ref=dailydev#heading-prerequisites)
-   [Get Your OpenAI key](https://www.freecodecamp.org/news/ai-chatbot-with-spring-react-docker/?ref=dailydev#heading-get-your-openai-key)
-   [Build the REST API in Spring Boot](https://www.freecodecamp.org/news/ai-chatbot-with-spring-react-docker/?ref=dailydev#heading-build-the-rest-api-in-spring-boot)
-   [Build the ChatUI using Reactjs](https://www.freecodecamp.org/news/ai-chatbot-with-spring-react-docker/?ref=dailydev#heading-build-the-chatui-using-reactjs)
-   [How to Dockerize the Application](https://www.freecodecamp.org/news/ai-chatbot-with-spring-react-docker/?ref=dailydev#heading-how-to-dockerize-the-application)
-   [Run the Application](https://www.freecodecamp.org/news/ai-chatbot-with-spring-react-docker/?ref=dailydev#heading-run-the-application)
-   [Congratulations 🎉](https://www.freecodecamp.org/news/ai-chatbot-with-spring-react-docker/?ref=dailydev#heading-congratulations)
...
3.  Install [JDK](https://jdk.java.net/java-se-ri/17-MR1), [Node Package Manager](https://docs.npmjs.com/downloading-and-installing-node-js-and-npm) and [Docke](https://docs.docker.com/get-started/get-docker/)[r](https://docs.docker.com/desktop/) onto your machine.

## **Get Your OpenAI key**

First, you’ll need to sign up for an [OpenAI](https://platform.openai.com/) account if you don’t have one. Once signed in, you’ll be taken to the homepage.
...
![[a3a78bc85adb1c5223cf5d303d73bd64_MD5.jpg]]

Copy the secret key and save it somewhere safe, as you’ll need it later to connect your app to the OpenAI API.

You can go through the OpenAI [API reference guide](https://platform.openai.com/docs/api-reference/authentication) to learn more about how to call the APIs, what requests it accepts, and the responses it gives.
...
![[e4317cc413ba91a6a318640e390494bf_MD5.jpg]]
...
You can either use Postman (https://www.postman.com/) or the [Curl](https://curl.se/) command to test your REST API:
...
This button triggers the `handleSend()` function when clicked. The icon used here is a [paper plane](https://react-icons.github.io/react-icons/icons/fa/), which is common for "send" buttons.
...
## **How to Dockerize th**e Applic**ation**
...
The source code shown in the project is available on [Github](https://github.com/vikasrajputin/springboot-react-docker-chatbot), if you found it helpful give it a star, and feel free to fork it and play around with it.

___

[[AI Agents]]   [[Docker]]  [[Chatbots]]